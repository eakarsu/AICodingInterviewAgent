 ...
 * In-memory + DB-detect fallback. Persistent storage requires a Webhook
 * Sequelize/SQL model — flagged in backlog.
 *   GET    /api/webhooks
 *   GET    /api/webhooks/:id
 *   POST   /api/webhooks
 *   PUT    /api/webhooks/:id
 *   DELETE /api/webhooks/:id
 *   POST   /api/webhooks/:id/test  (manual delivery probe)
 */
